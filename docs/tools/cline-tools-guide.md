...
有关最新的实现细节，您可以在 [Cline 代码库](https://github.com/cline/cline/blob/main/src/core/Cline.ts) 中查看完整源代码。

Cline 可以使用以下工具执行各种任务：
